...
- Add a new scoped location to [ingestion/location_targets.csv](../ingestion/location_targets.csv), update [ingestion/city_scope.py](../ingestion/city_scope.py), rerun ingestion, Spark, warehouse load, and dbt.
