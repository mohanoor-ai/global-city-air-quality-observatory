...
FROM `your-gcp-project-id.air_quality_dbt_marts.mart_pm25_city_daily`
UNION ALL
SELECT 'mart_city_pollution_trends', COUNT(*)
FROM `your-gcp-project-id.air_quality_dbt_marts.mart_city_pollution_trends`
UNION ALL
SELECT 'mart_city_pollutant_distribution', COUNT(*)
FROM `your-gcp-project-id.air_quality_dbt_marts.mart_city_pollutant_distribution`
UNION ALL
SELECT 'mart_city_extreme_events', COUNT(*)
FROM `your-gcp-project-id.air_quality_dbt_marts.mart_city_extreme_events`
UNION ALL
SELECT 'mart_city_comparison_summary', COUNT(*)
FROM `your-gcp-project-id.air_quality_dbt_marts.mart_city_comparison_summary`;
